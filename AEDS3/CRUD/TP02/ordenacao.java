...
public class ordenacao {
  ...
  public static int qtdElementoArrayIndice(Clubesindice[] a) {
    // pega a quantidade de elementos presente no array de objeto indice
    int contador = 0;
  ...
  public static void limparArquivoDoZeros(long tamArq) {
    ...
    try {
      RandomAccessFile arq = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/aindices.db", "rw");
    ...
    try {
      ...
      if (arq.length() > 13) {
        ...
        if (lerLong == 0) {
          ...
          Clubesindice indd = new Clubesindice();
      ...
      System.out.println("Ocorreu um erro ao corrigir o arquivo de dados: " + e.getMessage());
    }
  ...
  public static boolean ordernar1e2para3(RandomAccessFile arq1, RandomAccessFile arq2, RandomAccessFile arq3,
    ...
    try {
      ...
      Clubesindice ic2 = new Clubesindice();
  ...
  public static boolean ordernar1e2para4(RandomAccessFile arq1, RandomAccessFile arq2, RandomAccessFile arq4,
    ...
    try {
      ...
      } else {// caso o arquivo 1 seja incompleto
        int qtdElementosNoCaminho = 0;
  ...
  public static void ordernarToArqIndice(Boolean ultimoSavearq1, boolean ultimoSavearq2, boolean ultimoSavearq3,
    ...
    try {
      RandomAccessFile arqIndice = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/aindices.db", "rw");
      if (ultimoSavearq1 == true) {

        RandomAccessFile arq1 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq1.db", "rw");
      ...
      if (ultimoSavearq2 == true) {
        ...
        RandomAccessFile arq2 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq2.db", "rw");
      ...
      if (ultimoSavearq3 == true) {
        ...
        RandomAccessFile arq3 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq3.db", "rw");
      ...
      if (ultimoSavearq4 == true) {
        ...
        RandomAccessFile arq4 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq4.db", "rw");
  ...
  public void ordenacaoDistribuicao() {
    corrigirArquivoIndice();
    arqcrud arqcru = new arqcrud();
    arqcru.deletaTudo(-1, 1, 1, -1, -1, -1, -1);
    ...
    try {
      ...
      RandomAccessFile arq1 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq1.db", "rw");
      RandomAccessFile arq2 = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/arq2.db", "rw");
      RandomAccessFile arqI = new RandomAccessFile("C:/Users/thiag/Downloads/AEDS3/CRUD/TP02/Arquivos/aindices.db", "rw");

      long tamArquivoIndice = arqI.length();
      int inteirotamArquivoIndice = (int) tamArquivoIndice;// tamanho total do arquivo

      Clubesindice indiceArray[];
      indiceArray = new Clubesindice[10];// abri 10 casas de array do objeto indice
      ...
      if (inteirotamArquivoIndice != 0) {
        ...
        while (contadorPrincipal < inteirotamArquivoIndice) {
          ...
          if (contadorParaSalvarNoArquivo1 == 9 || contadorPrincipal == inteirotamArquivoIndice2
              || contadorParaSalvarNoArquivo1 == 19) {
            ...
            indiceArray = new Clubesindice[10];
